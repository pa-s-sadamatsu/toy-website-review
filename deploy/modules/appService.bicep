...
@description('The name of storage account to deploy. This name must be globally unique.')
param storageAccountName string

@description('The name of queue to deploy for processing orders.')
